    ...
    <div>
        <form @submit.prevent="submitForm">
            ...
            <div class="for-group row">
                ...
                <!-- <div class="col">
                    <Dropdown v-model="state.teacher" :options="store.teachers.value" optionLabel="firstName" optionValue='id' placeholder="Select a teacher"
                        class="w-full md:w-14rem" />
                </div> -->
            </div>
...
const existingApp = reactive(dialogRef.value.data.application);
...
function deleteApplication(app) {
    ...
    $.ajax({
        ...
        url: "http://localhost:8080/api/v1/Application/Delete?id=" 
        + app.id,
